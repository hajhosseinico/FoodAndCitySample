...
class FoodRecyclerAdapter(private val interaction: Interaction? = null) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<FoodNetworkEntity>() {

        override fun areItemsTheSame(
            oldItem: FoodNetworkEntity,
            newItem: FoodNetworkEntity
        ): Boolean {
            return false
        }
    ...
    fun submitList(list: List<FoodNetworkEntity>) {
    ...
    constructor(
        ...
        fun bind(item: FoodNetworkEntity) = with(itemView) {
...
//                .placeholder(R.drawable.ic_placeholder)
            ...
            itemView.findViewById<TextView>(R.id.txtDescription).visibility = View.GONE
        }
    }

    interface Interaction {
        fun onItemSelected(position: Int, item: FoodNetworkEntity)
    }
}
